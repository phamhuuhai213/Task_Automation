...
1.  Nhấn phím `Windows`, gõ **"Windows Defender Firewall with Advanced Security"** và mở nó lên.
2.  Chọn **"Advanced Setting"** và mở nó lên.
...
10. Đặt tên cho quy tắc này là: `Task_Automation_Ports` và bấm **Finish**.
